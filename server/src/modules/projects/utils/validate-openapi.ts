...
export function validateOpenApiSpec(spec: unknown): void {
    ...
    const isOpenApi = typeof document.openapi === "string" || typeof document.swagger === "string"

    if(!isOpenApi) {
        throw new BadRequestException("URL does not contain an OpenAPI/Swagger document")
    }
}