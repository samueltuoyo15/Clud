import { IsIn, IsInt, IsNotEmpty, IsOptional, IsString, IsUrl, Min, ValidateIf } from "class-validator"
...
export class CreateProjectDTO {
    ...
    @IsUrl({ require_tld: false }, { message: "Please provide a valid URL for the spec" })
    spec_url!: string
    ...
    @IsIn(["none", "basic"], { message: "Auth type must be either 'none' or 'basic'" })
