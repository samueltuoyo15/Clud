      ...
      <main className="flex-1 max-w-3xl w-full mx-auto py-16 px-6">
        ...
        <div className="space-y-6 text-sm text-neutral-600 leading-relaxed">
          ...
          <section>
            ...
            <p>To request a refund, please contact us at support@samueltuoyo.com from the email address associated with your account. We will process your request within 24-48 hours.</p>
          </section>
